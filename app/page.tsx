        ...
        <section className="pb-4">
          ...
          {showContact && (
            <div className="space-y-2.5 mt-2.5">
              ...
              <a href="https://whatsapp.com/channel/0029Vb42kD0HFxPA8UGJRF3i" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2.5 bg-white p-3.5 rounded-xl border border-gray-100 hover:border-green-300 hover:shadow-md transition-all">
                ...
                <div><p className="text-xs font-semibold">WhatsApp Channel</p><p className="text-[10px] text-gray-500">Join for updates</p></div>
              </a>
            </div>
          )}
        </section>
      ...
      <footer className="py-5 bg-gray-50 border-t border-gray-100">
        <div className="max-w-lg mx-auto px-5 text-center">
          ...
          <p className="text-[11px] text-gray-400 mb-2">A Hashtag Dropee Initiative — eX Holdings</p>
           ...
           <a href="https://whatsapp.com/channel/0029Vb42kD0HFxPA8UGJRF3i" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 text-[11px] text-gray-400 hover:text-green-600 transition">
